...
import { instructionsInStage, isBroadSourceCopy, matchPackageManager } from './helpers.mjs';
...
function findInStage(dockerfile, stageIndex) {
  ...
  for (const instruction of instructionsInStage(dockerfile, stageIndex)) {
    ...
    if (broadCopy && instruction.keyword === 'RUN' && matchPackageManager(instruction.args)) {
